<?php
    ...
    if( count($serverErrors) > 0 ) {
        ...
        */
        ...
        $message .= '<p style="color: #999999; font-size: 11px; margin-top: 50px;"> Powered by <a href="https://themeganj.com" style="color: #EB3B5B">Simple AJAX Contact Form</a></p>';
        $message .= '</body></html>';
